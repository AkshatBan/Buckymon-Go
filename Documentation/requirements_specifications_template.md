...
| R12  | The frontend should display a map of a user's surrounding area with markers for nearby areas with activities. | Med.     | Open   | Check that the backend returns a list of uncompleted events of user in the format, according to the API Documentation. |
